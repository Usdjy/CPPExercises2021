...
protected:
    std::vector<int> parent; // массив который для каждого элемента хранит номер его родителя в подвешенном дереве (или ROOT=-1 если вершина - корень множества и родителя нет)
